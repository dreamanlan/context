...
copy /Y build.Android.armeabi-v7a\libboost_context.a Plugins\Android\ARMv7\libboost_context.a
...
copy /Y build.Android.arm64-v8a\libboost_context.a Plugins\Android\ARM64\libboost_context.a
...
copy /Y build.Android.x86\libboost_context.a Plugins\Android\x86\libboost_context.a
...
copy /Y build.Android.x86_64\libboost_context.a Plugins\Android\x64\libboost_context.a
